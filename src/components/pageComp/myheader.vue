    ...
    <nav class="navbar myNavbar navbar-fixed-top">
      <div class="container myContainer">
        ...
        <div class="navbar-header">
          <button
            type="button"
            class="navbar-toggle collapsed myToggle"
          ...
          <a class="navbar-brand myNavbrand" href="#">
            <img src="/static/img/logo.png" class="logo" alt="安志生态">
          </a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div
          class="collapse navbar-collapse navbar-right myNavCollapse"
        ...
        >
          <ul class="nav navbar-nav myNav" id="navbar">
            <li
              ...
              :key="index"
              v-bind:class="{'active':curPage === item.path}"
            >
